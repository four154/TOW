var rid='190b9239650x4e47fc46x28dwpc';
...
$(`<style>
.nosel.d-flex.room.r190b9239650x4e47fc46x28dwpc .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r190b9239650x4e47fc46x28dwpc .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.room.r190b9239650x4e47fc46x28dwpc.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r190b9239650x4e47fc46x28dwpc .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r190b9239650x4e47fc46x28dwpc {
...
.nosel.d-flex.room.r190b9239650x4e47fc46x28dwpc .u-topic.dots {
...
setInterval(function () {
    if (myroom == '190b9239650x4e47fc46x28dwpc') {
        if (l7dah == false) {
            l7dah = true;
